...
static const uint8_t DSP_INIT[] PROGMEM = {
    ...
    0x07, 0x20, 0x0B, 0x01, 0x03, 0x48, 0x00, 0x00,                         //AGC
    0x00};
...
typedef struct Quality
{
    ...
    {
        return to_string(QualityTimeStamp/10)+"ms";
    }

    string GetLevelString()
    {
        return to_string(Level/10)+"dBuv";
    }

    string GetNoiseString()
    {
        return to_string(Noise/10)+"%";
    }

     string GetWamString()
    {
        return to_string(Wam/10)+"%";
    }

    string GetOffsetString()
    {
        return to_string(Offset/10)+"kHz";
    }

    string GetBandwidthString()
    {
        return to_string(Bandwidth/10)+"kHz";
    }

     string GetModulationString()
    {
        return to_string(Modulation/10)+"%";
    }
